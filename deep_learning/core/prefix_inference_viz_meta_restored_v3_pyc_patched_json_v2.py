...
def make_task_prefix(
    ...
    # If we cap support at EOL exactly, query can become all-zeros (RUL=0) for short-life batteries.
    # Prefer keeping the split strictly BEFORE EOL so query contains at least the last positive point.
