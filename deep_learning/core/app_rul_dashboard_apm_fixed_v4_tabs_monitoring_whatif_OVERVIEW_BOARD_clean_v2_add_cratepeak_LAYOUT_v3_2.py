...
# cd /Users/velocitygoal/battery_project/v11

# streamlit run server/backend/deep_learning/core/app_rul_dashboard_apm_fixed_v4_tabs_monitoring_whatif_OVERVIEW_BOARD_clean_v2_add_cratepeak_LAYOUT_v3_14_fix_df_scen.py \
#   --server.port 8502 \
