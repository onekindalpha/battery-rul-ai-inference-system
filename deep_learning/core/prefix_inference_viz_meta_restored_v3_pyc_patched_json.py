...
# ( PYTHONPATH=$PWD META_DEBUG=1 python deep_learning/core/prefix_inference_viz_meta_restored_v3_pyc_patched_json.py \
#   --ckpt /Users/velocitygoal/battery-rul-v11/core_checkpoints/nasa_bmaml_best.pt \
#   --bids 18,42,43 --r_ratio 0.15 --out_dir ./viz_r0p15 --save_json 1 --save_batch_json 1 \
# ) |& tee ./viz_r0p15/run.log