# deep_learning/core/export_rul_dashboard_data_meta_fixed.py
...
# python -m deep_learning.core.export_rul_dashboard_data_meta_fixed \
#   --ckpt /Users/velocitygoal/Desktop/battery_project/v11/deep_learning/core/core_checkpoints/nasa_bmaml_best_re.pt \
#   --eval_dataset from_ckpt \
#   --r_ratio "0.00,0.05,0.10,0.15,0.20,0.25,0.30" \
#   --bids B0018,B0042,B0043 \
#   --out_dir /Users/velocitygoal/battery-rul-v11/battery_rul_fastapi_react_mvp/data/dashboard_export_v3/bmaml_v3
